...
class ResNet(nn.Module):
    ...
    def __init__(self, block, deform_block, layers,  zero_init_residual=False):
        ...
        self.layer4 = self._make_layer(deform_block, 512, layers[3], stride=2)
...
def resnet18(pretrained=False, **kwargs):
    ...
    """
    model = ResNet(BasicBlock, BasicDeformableBlock, [2, 2, 2, 2], **kwargs)
    return model
...
def resnet34(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, BasicDeformableBlock, [3, 4, 6, 3], **kwargs)
    return model
...
def resnet50(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, DeformableBottleneck, [3, 4, 6, 3], **kwargs)
    return model
...
def resnet101(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, DeformableBottleneck, [3, 4, 23, 3], **kwargs)
    return model
...
def resnet152(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, DeformableBottleneck, [3, 8, 36, 3], **kwargs)
    return model
